...
class ControllerTest {
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM vehiclerental_434.Verfication");
    jdbcTemplate.execute("DELETE FROM vehiclerental_434.Payment");
    jdbcTemplate.execute("DELETE FROM vehiclerental_434.Customer");
    jdbcTemplate.execute("DELETE FROM vehiclerental_434.Insurance");
    jdbcTemplate.execute("DELETE FROM vehiclerental_434.ServiceCrew");
    jdbcTemplate.execute("DELETE FROM vehiclerental_434.ReturnRentedBike");
    jdbcTemplate.execute("DELETE FROM vehiclerental_434.Booking");
    jdbcTemplate.execute("DELETE FROM vehiclerental_434.RoadsideAssistance");
    jdbcTemplate.execute("DELETE FROM vehiclerental_434.ExtendBooking");
    jdbcTemplate.execute("DELETE FROM vehiclerental_434.RentalCompany");
    jdbcTemplate.execute("DELETE FROM vehiclerental_434.ReturnBikeInspection");
    jdbcTemplate.execute("DELETE FROM vehiclerental_434.Bike");
     jdbcTemplate.execute("DELETE FROM vehiclerental_434.ReturnRentedBikeInspection");
     jdbcTemplate.execute("DELETE FROM vehiclerental_434.CustomerExtendRental");
     jdbcTemplate.execute("DELETE FROM vehiclerental_434.RentalCompanyBookings");
     jdbcTemplate.execute("DELETE FROM vehiclerental_434.RentalCompanyCustomers");
     jdbcTemplate.execute("DELETE FROM vehiclerental_434.CustomerBookings");
     jdbcTemplate.execute("DELETE FROM vehiclerental_434.RentalCompanyBikes");
     jdbcTemplate.execute("DELETE FROM vehiclerental_434.CustomerReturns");
